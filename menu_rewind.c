 ...
 *    rin_frame("¡õ£ºDon't Use max ¡Á£ºCancel ¡ð£ºSave ");
 *    rin_frame("¡õ£ºUse max <-£ºSub ->£ºAdd¡¡¡Á£ºCancel ¡ð£ºSave ");
 *
...
static void rin_frame_rewind_use_max() {
	rin_frame(rin_frame_get_title(),"¡õ£ºDon't use max ¡Á£ºCancel ¡ð£ºSave ");
}

static void rin_frame_rewind_no_max(){
	rin_frame(rin_frame_get_title(),"¡õ£ºUse max ¡û£ºSub ¡ú£ºAdd¡¡¡÷:(press) Fine tune ¡Á£ºCancel ¡ð£ºSave ");
}

static void rin_frame_rewind_disabled(){
	rin_frame(rin_frame_get_title(),"¡÷: Enable Rewind ¡Á£ºCancel ¡ð£ºSave ");
}

static void rin_frame_rewind_change_mode(){
	rin_frame(rin_frame_get_title(),"¡û¡ú£ºChange limit mode ¡÷: Disable Rewind ¡Á£ºCancel ¡ð£ºSave ");
}
